...
(gtk_accel_path "<Actions>/win.edit.duplicate-line-selection" "<Primary>d")
...
(gtk_accel_path "<Actions>/win.file.detach-tab" "<Primary><Alt>d")
...
(gtk_accel_path "<Actions>/win.edit.delete-line" "<Primary><Shift>d")
